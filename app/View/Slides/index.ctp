<div class="slides index">
	...
	<tr>
		...
		<td><?php echo h($slide['Slide']['publish']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $slide['Slide']['id']), array(), __('Are you sure you want to delete # %s?', $slide['Slide']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
